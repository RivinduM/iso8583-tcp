...
public type ISOLibraryConfig record {|
    string fieldDefFilePath?;
    string fieldNamesFilePath?;
|};

public type ISOMessage record {|
    int headerLength;
    int mtiLength;
    string versionNameString?;
|};

public type BackendServiceConfig record {|
    string host;
    int port;
|};
